...
const About = () => {
    return (
      <div className="container-fluid col-md-4 mt-5">
        ...
        <p><img src={sudha} alt=""/>Front-end web developer/Graphic designer with more than five years of experience. Passionate about creating meaningful web applications. With each project, my aim is to best engage the audience for an impactful user experience.
        </p>
